...
align-items-center pb-2 mb-3 border-bottom">
        ...
        <div id="messageContainer">
            <?php if ($message): ?>
            <div class="alert alert-<?php echo $message_type; ?> alert-
                ...
                <div class="card-body">
                    <form method="POST" class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <label for="categoryDescription" class="form-
            ...
            <div class="card-body">
                <form method="POST" class="row g-3">
                    <div class="col-md-4">
                        ...
                        <input type="text" value="<?php echo $name; ?>" class="form-
control" id="categoryName" name="name">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" value="<?php echo $description; ?>" class="form-
control" id="categoryDescription" name="description">
...
$stmt = $pdo->prepare("UPDATE categories SET name = ?, description
= ? WHERE id = ?");
